...
dataset_info = dict(
    ...
    keypoint_info={
        # ,"supercategory":"","keypoints":["right_ankle","right_knee","right_hip","right_shoulder","right_elbow","right_wrist","head"],"skeleton":[[1,2],[3,4],[2,3],[4,5],[5,6],[4,7]]
        ...
        6: dict(name='head', id=6, color=[51, 153, 255], type='upper')
    },
    skeleton_info={
        ...
        5: dict(link=('right_shoulder', 'head'), id=5, color=[255, 128, 0])
    },
